...
Estado: vigente aceptado.
Fecha de emision: 2026-05-20.
Fecha de aceptacion: 2026-05-20.
Audiencia: producto, arquitectura, desarrollo, operaciones, contabilidad y cierre productivo.
Sustituye a: `05_Contexto_Historico/PRD_CANONICO_MARZO_2026_HISTORICO.md`.

## 1. Proposito documental

Este documento es la version canonica vigente de producto para LeaseManager. Nivela hacia arriba los 26 PRD fuente, el PRD canonico de marzo 2026, la Arquitectura Maestra LeaseManager, los documentos de readiness operativo, el contexto del Excel legacy Mayo 2026, las correcciones confirmadas por el usuario, el codigo real y los gates existentes.

Este PRD reemplaza al PRD canonico de marzo 2026 como contrato rector de producto. Su funcion es mantener una base profesional, sin herencia operativa innecesaria y sin arrastrar decisiones antiguas que ya no representan el estado real del producto.
...
La jerarquia vigente queda asi:

1. PRD Canonico Mayo 2026: mision, dominio, alcance, reglas de producto y acceptance.
...
- Reconciliar cualquier mencion heredada de stack antiguo con
  `ADR_STACK_FINAL.md` y el root limpio Django/React antes de cerrar producto.
...
- separar fuente vigente, anexos e historicos;
...
Como este PRD queda aceptado como rector, el proyecto debe continuar desde una base limpia o controlada, no desde una masa anonima de cambios pendientes.
