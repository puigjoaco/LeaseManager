...
| `SII.F29Presentacion` | `SII` | `Condicionado` | `F29Preparacion` valida, gate especifico abierto, politica de aprobacion vigente y responsable humano trazado | cambio normativo, error de presentacion o gate sin readiness | reapertura formal y prueba exitosa con aprobacion responsable | presentacion manual externa con evidencia | simulacion end-to-end aprobada y aprobacion trazada |
...
| `SII.F22Preparacion` | `SII` | `Condicionado` | proceso anual aprobado como dossier revisable, `ConfiguracionFiscalEmpresa` vigente, mapeo tributario vigente, borrador probado y responsable trazado | cambio normativo, inconsistencias anuales o fallo sistematico | reapertura con validacion anual y aprobacion responsable | borrador y revision manual | borrador anual trazado contra datos de ledger y checklist de revision |
