      ...
      <section className="form-grid">
        ...
        <section className="panel">
          ...
          <form className="entity-form" onSubmit={handleCreateContrato}>
            ...
            <input type="date" aria-label="Fecha registro operativo" title="Fecha registro operativo" value={contratoDraft.fecha_registro_operativo} onChange={(event) => setContratoDraft((current) => ({ ...current, fecha_registro_operativo: event.target.value }))} />
