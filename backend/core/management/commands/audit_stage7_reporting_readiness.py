...
from core.stage7_reporting_readiness import (
    AUTHORIZED_STAGE7_REPORTING_SOURCE_KINDS,
    collect_stage7_reporting_readiness,
)
...
class Command(BaseCommand):
    help = 'Audita readiness de Etapa 7 Reporting trazable sin usar datos reales ni servicios externos.'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--source-kind',
            default='local',
            choices=sorted(LOCAL_DIAGNOSTIC_SOURCE_KINDS | AUTHORIZED_STAGE7_REPORTING_SOURCE_KINDS),
            help=(
