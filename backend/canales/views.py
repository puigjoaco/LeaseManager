...
class AuditCreateUpdateMixin:
    audit_entity_type = ''
    audit_entity_label = ''
    audit_state_fields = ('estado_gate', 'estado', 'activa')
                ...
                'notificaciones_cobranza': [
                    {
                        ...
                        'arrendatario': item.pago_mensual.contrato.arrendatario_id,
                        'pago_anio': item.pago_mensual.anio,
                        'pago_mes': item.pago_mensual.mes,
                        'pago_estado': item.pago_mensual.estado_pago,
                        'pago_fecha_vencimiento': item.pago_mensual.fecha_vencimiento.isoformat(),
                        'pago_monto_facturable_clp': str(item.pago_mensual.monto_facturable_clp),
                        'configuracion': item.configuracion_id,
                        'configuracion_activa': item.configuracion.activa,
                        'configuracion_dias_notificacion': item.configuracion.dias_notificacion,
                        'canal': item.canal,
