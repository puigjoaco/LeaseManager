...
from .views import (
    ...
    ConfiguracionNotificacionContratoDetailView,
    ConfiguracionNotificacionContratoListCreateView,
    MensajePrepararView,
...
urlpatterns = [
    ...
    path(
        ...
        ConfiguracionNotificacionContratoListCreateView.as_view(),
        name='canales-notificacion-contrato-list',
    ),
    path(
        'notificaciones-contrato/<int:pk>/',
        ConfiguracionNotificacionContratoDetailView.as_view(),
        name='canales-notificacion-contrato-detail',
    ),
