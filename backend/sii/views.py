                ...
                'annual_tax_review_checklists': [
                    {
                        ...
                        'warnings_total': item.warnings_total,
                        'review_decision_state': item.review_decision_state,
                        'review_decision_ref': redact_sensitive_reference(item.review_decision_ref),
                        'review_decision_evidence_ref': redact_sensitive_reference(item.review_decision_evidence_ref),
