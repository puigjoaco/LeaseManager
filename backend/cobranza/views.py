                ...
                'pagos': [
                    {
                        'id': item.id,
                        'contrato': item.contrato_id,
                        'periodo_contractual': item.periodo_contractual_id,
                        'mes': item.mes,
                        'anio': item.anio,
                        ...
                        'moneda_calculo': item.moneda_calculo,
                        'uf_fecha_usada': item.uf_fecha_usada,
                        'uf_valor_usado': item.uf_valor_usado,
                        'uf_source_key': item.uf_source_key,
                        ...
                        'fecha_deposito_banco': item.fecha_deposito_banco,
                        'estado_pago': item.estado_pago,
                        'repactacion_deuda': item.repactacion_deuda_id,
                        'dias_mora': item.dias_mora,
                        'fecha_pago_webpay': item.fecha_pago_webpay,
                        'fecha_deteccion_sistema': item.fecha_deteccion_sistema,
                        'codigo_conciliacion_efectivo': item.codigo_conciliacion_efectivo,
