...
class ConciliacionAPITests(APITestCase):
    ...
    def test_conciliacion_admin_redacts_sensitive_bank_refs(self):
        ...
        self.assertNotIn('cuenta_recaudadora', connection_admin.fields)
        self.assertNotIn('cuenta_recaudadora', connection_admin.list_display)
        self.assertNotIn('cuenta_recaudadora__numero_cuenta', connection_admin.search_fields)
        self.assertIn('cuenta_recaudadora_redacted', connection_admin.fields)
        self.assertIn('cuenta_recaudadora_redacted', connection_admin.readonly_fields)
        self.assertIn('cuenta_recaudadora_redacted', connection_admin.list_display)
        connection_account_label = connection_admin.cuenta_recaudadora_redacted(conexion)
        self.assertIn(str(cuenta.pk), connection_account_label)
        self.assertNotIn(cuenta.numero_cuenta, connection_account_label)
        ...
        self.assertNotIn('cuenta_recaudadora', unknown_income_admin.fields)
        self.assertNotIn('cuenta_recaudadora', unknown_income_admin.list_display)
        self.assertIn('cuenta_recaudadora_redacted', unknown_income_admin.fields)
        self.assertIn('cuenta_recaudadora_redacted', unknown_income_admin.list_display)
        unknown_income_account_label = unknown_income_admin.cuenta_recaudadora_redacted(ingreso)
        self.assertIn(str(cuenta.pk), unknown_income_account_label)
        self.assertNotIn(cuenta.numero_cuenta, unknown_income_account_label)
        ...
        self.assertNotIn('cuenta_recaudadora', balance_admin.fields)
        self.assertNotIn('cuenta_recaudadora', balance_admin.list_display)
        self.assertNotIn('cuenta_recaudadora__numero_cuenta', balance_admin.search_fields)
        self.assertIn('cuenta_recaudadora_redacted', balance_admin.fields)
        self.assertIn('cuenta_recaudadora_redacted', balance_admin.list_display)
        balance_account_label = balance_admin.cuenta_recaudadora_redacted(cuadratura)
        self.assertIn(str(cuenta.pk), balance_account_label)
        self.assertNotIn(cuenta.numero_cuenta, balance_account_label)
