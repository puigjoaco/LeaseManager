...
`Contabilidad` / `SII` / `Reporting` ya tienen una primera base mensual no vacia para empresa `1`, con `DTE` borrador y `F29` preparada en `2026-05`, pero siguen lejos de un dataset rico.
