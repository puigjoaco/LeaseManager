...
| Contratos | `resuelto_confirmado_local` | `Arrendatario`, `Contrato`, `ContratoPropiedad`, `PeriodoContractual`, `AvisoTermino`, `CodeudorSolidario`; validaciones, endpoint de renovacion automatica y tests de contrato futuro/aviso | datos contractuales reales siguen como validacion de negocio |
