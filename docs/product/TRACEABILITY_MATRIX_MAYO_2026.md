...
| Contratos | PRD, reglas contractuales | `backend/contratos`, backoffice contratos | 1 | implementado_sin_evidencia | Matriz contrato-propiedad-periodo-garantia | Usar `audit_stage1_matrix`; calendario mensual, continuidad de periodos, minimo operativo y coherencia de garantias ya tienen gate local. |
