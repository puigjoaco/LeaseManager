...
| Brecha activa | Ninguna. Ultimo paquete preparado: Etapa 2 / Canales normaliza `NotificacionCobranzaProgramada.motivo_estado` antes de persistir motivos de notificaciones de cobranza omitidas. |
