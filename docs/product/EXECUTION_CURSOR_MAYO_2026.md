...
| Brecha activa | Ninguna. Ultimo paquete preparado: Etapa 2 / Canales normaliza `MensajeSaliente.external_ref` y `motivo_bloqueo` antes de persistir procedencia de mensajes salientes. |
