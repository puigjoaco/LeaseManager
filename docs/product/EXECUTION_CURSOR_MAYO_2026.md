...
| Fuente exacta | `main` en `9072c03e`, despues del merge confirmado de PR #938 `codex/ownership-visual-index-checklist`. |
...
| Worktree | No hay worktree tactico activo de producto. Existe worktree historico pausado `C:/Users/puigj/.codex/worktrees/b2d9/LeaseManager` en rama `codex/thread-019ea306-rescue`; no tocar, no stagear y no subir sus PDFs/artefactos salvo decision explicita. |
| Rama | `main` limpio para inspeccion. Abrir `codex/...` solo si una herramienta minima resulta indispensable para cargar, comparar, auditar o cuadrar esta contabilidad. |
| Estado | PR #938 ya esta mergeado y su worktree tactico fue removido. No reabrir ese paquete. AC2024/AT2025 aparece como paquete local preparado al 100% para revision responsable, pero no como cierre final autonomo. AC2025/AT2026 tiene RCV/F29/libros/insumos anuales disponibles, pero sigue sin snapshot ownership controlado ni writer anual listo. |
...
| Estado al cerrar paquete | El siguiente cierre valido debe producir claridad contable por ano y capa: insumos disponibles, faltantes, carga al modelo, calculos contables, calculos tributarios, comparacion AC2024/AT2025 contra contadora/SII, y produccion auditada AC2025/AT2026. |
| Bloqueos relacionados | AC2024/AT2025 conserva bloqueos Stage 6 de registros empresariales y bienes raices antes de cierre final. AC2025/AT2026 requiere snapshot ownership/vigencia al 31-12-2025, valores manuales del writer anual, revision responsable, y certificado/cartola formal Banco Chile 31-12-2025 o autorizacion responsable para soporte observado. |
...
| Siguiente accion | Construir o actualizar el tablero contable de Inmobiliaria Puig desde evidencia local: AC2024/AT2025 como calibracion contra contadora/SII y AC2025/AT2026 como produccion observada. Juntar dudas concretas para Joaquin sobre ownership, Banco Chile/leasing, criterios tributarios y documentos faltantes. |
