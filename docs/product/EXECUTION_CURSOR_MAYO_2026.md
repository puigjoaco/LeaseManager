...
| Siguiente accion | Cerrar PR/CI/merge del paquete `codex/ac2024-mirror-source-bundle` cuando sea posible y ejecutar OCR/revision manual controlada sobre los 10 `manual_review_required_legal_candidate`; completar `annual_tax_ownership_snapshot_template_ac2024_at2025_v1.json` con socios/participaciones vigentes AC2024 solo si la fuente lo prueba, y luego inyectar `ownership` al paquete controlado para writer/mirror. Despues revisar artefactos generados/responsable, bienes raices/respaldo tributario y gates finales de Etapa 6. No reabrir los 30 faltantes de `balance_general`, DDJJ/F22 semantico, goal prompts, EDIG ni RLI/CPT/RAI/SAC como bloqueo general salvo bug nuevo. |
