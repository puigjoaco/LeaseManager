...
| Campo | Valor |
| --- | --- |
| Frente activo | Sin paquete tactico abierto; ultimo cierre Etapa 1 - Servicios y gastos comunes estructurados de propiedad. |
| Fuente exacta | PR #181 `Structure property services`, merge `a0f808e`, desde `01_Set_Vigente/PRD_CANONICO.md` linea 407. |
| Brecha activa | Cerrada localmente: `ServicioPropiedad` modela servicios/gastos comunes estructurados; API, snapshot y auditor Etapa 1 quedan cubiertos. |
...
| Estado | PR #181 integrado en `main`, CI `acceptance` verde, worktree/rama tactica eliminados. |
