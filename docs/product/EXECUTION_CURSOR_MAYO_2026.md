...
| Fuente exacta | Estado real de `main` en `f15f6e3` despues de PR #634, stage cards, trazabilidad, evidencia y bloqueos vigentes. |
| Brecha activa | Sin paquete tactico abierto. |
| Motivo de prioridad | PR #634 cerro la validacion temporal de estados historicos en auditoria de exportaciones sensibles de Compliance. |
...
| Estado al cerrar paquete | PR #634 mergeado en `f15f6e3`; validacion local completa OK; CI GitHub acceptance OK; worktree `D:/Proyectos/LeaseManager-compliance-audit-event-state` pendiente de eliminacion tras cerrar cursor. |
