...
| Siguiente accion | Validar suite impactada del paquete `codex/ac2024-mirror-source-bundle`, cerrar PR/CI/merge cuando sea posible, y continuar con la prueba espejo desde los 30 faltantes de `balance_general`; luego cubrir DDJJ/F22 con extractor semantico de valores y mantener outputs finales solo como comparacion. No reabrir goal prompts, EDIG ni RLI/CPT/RAI/SAC como bloqueo general salvo bug nuevo. |
