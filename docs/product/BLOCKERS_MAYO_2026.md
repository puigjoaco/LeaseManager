...
| BLK-003 | Integraciones externas no estan abiertas por defecto. | bloqueado_externo | Email, WebPay, banco, UF, SII y storage no pueden declararse productivos. Email y WebPay ya tienen guardas locales trazables, pero no prueba productiva/sandbox autorizada. | Permisos, credenciales seguras, entorno aislado, pruebas y rollback. | abierto |
